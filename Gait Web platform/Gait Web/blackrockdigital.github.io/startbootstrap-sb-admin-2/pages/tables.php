...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Accelerometer Readings</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
 ...
 var database=firebase.database();
      ...
      var age = new Array();
      var acc_ankle = new Array();
      var acc_thigh = new Array();

      var acc_trunk = new Array();
        ...
        var users=data.val();
              for(x in users){
               uid.push(x);
                 ...
                 acc_ankle.push(users[x].acc_ankle);
                                  acc_trunk.push(users[x].acc_trunk);

                 acc_thigh.push(users[x].acc_thigh);
           ...
           disptable(uid,age, acc_ankle,acc_thigh, acc_trunk,email,height,patient_name,weight,gender);
           loadlistners();
        }
...
Array.prototype.forEach.call(btns1, function addClickListener(btn1) {
  btn1.addEventListener('click', function(event) {
    ...
    var btn_value=ss2[2];
              ...
              document.getElementById("type").value="ankle";
...
Array.prototype.forEach.call(btns2, function addClickListener(btn2) {
  btn2.addEventListener('click', function(event) {
    ...
    var btn_value=ss2[2];
              ...
              document.getElementById("gender").value=ss2[0];
              document.getElementById("data").value=encodeURIComponent(btn_value);
              document.getElementById("type").value="thigh";
              document.getElementById("my_cust_form").submit();
...
Array.prototype.forEach.call(btns3, function addClickListener(btn3) {
  btn3.addEventListener('click', function(event) {
    ...
    var btn_value=ss2[2];
              ...
              document.getElementById("gender").value=ss2[0];
              document.getElementById("data").value=encodeURIComponent(btn_value);
              document.getElementById("type").value="trunk";
              document.getElementById("my_cust_form").submit();
    ...
    console.log(btn_value);
        ...
        function disptable(uid,age, acc_ankle, acc_thigh, acc_trunk,email,height,patient_name,weight,gender)
        {
        //console.log(img);
    ...
    // loop inner array
        // create td element
            ...
            row.appendChild(cell23);
               ...
               button1.id="but1"+i;
               button1.value=gender[i]+"^^"+uid[i]+"^^"+acc_ankle[i];
            ...
            var cell9 = document.createElement('td');
               ...
               button2.id="but2"+i;
               button2.value=gender[i]+"^^"+uid[i]+"^^"+acc_thigh[i];
            ...
            var cell10 = document.createElement('td');
               ...
               button3.id="but3"+i;
               button3.value=gender[i]+"^^"+uid[i]+"^^"+acc_trunk[i];
